<?php $formlar = [
    ...
    [
        'demirbas_kodu',
        'Demirbaş Kodu',
        $demirbas_data->kod_1 . ' ' . $demirbas_data->kod_2 . ' ' . $demirbas_data->kod_3 . ' ' . $demirbas_data->kod_4 . ' ' . $demirbas_data->kod_5 . ' ' .
        $demirbas_data->kod_6,
        'text',
        '',
...
<form id="demirbas_duzenle_form">
    ...
    <div style="float: left; width: 48%; margin: 5px" class="form-group">
        ...
        <div class="input-group">
            <?php echo $veri[5] ?>
            <input <?php echo $veri[6] ?>  type="<?php echo $veri[3] ?>" class="form-control <?php echo $veri[4] ?>" id="<?php echo $veri[0] ?>" name="<?php echo $veri[0] ?>" value="<?php echo $veri[2] ?>"/>
        </div>
    </div>
    <?php } ?>
    <?php } ?>
    ...
    <input type="hidden" id="yeni_demirbas" name="yeni_demirbas" value="<?php echo $yeni_demirbas ?>"/>
</form>
<div style="clear:both;"></div>
<br>
<div class="btn btn-primary btn-block" onclick="demirbas_duzenle_kaydet(<?php echo $demirbas_data->demirbas_id . ',' . $yeni_demirbas ?>)">DEĞİŞİKLİKLERİ KAYDET</div>
<div style="clear:both;"></div>
